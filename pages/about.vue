<template>
  <div class="flex flex-col w-1/2 justify-center">
    ...
    <h2 class="flex flex-row justify-center">Code of Ethics</h2>
    <p>
      Gigaquiz follows in sqlite's lead and purposes <span class="font-bold">The Rule</span> for all contributers to follow:
    </p>
    <ol class="list-decimal ml-16 text-lg font-bold">
